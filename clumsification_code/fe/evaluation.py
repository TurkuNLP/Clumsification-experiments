...
from .diagnostics import (
    ...
    write_pairwise_accuracy_history_plot,
)
from .utils import logger


@torch.no_grad()
def evaluate_pairwise_accuracy_distributed(
    model: nn.Module,
    dataset: Dataset,
    tokenizer,
    max_length: int,
    ...
    Main metric:
        pairwise_accuracy over all unequal-label pairs.
...
def baseline_pairwise_accuracies(dataset: Dataset) -> Dict[str, float]:
    """
