...
def write_winrate_history_plot(
    ...
    record = {
        ...
        "win_rate": safe_float_metric(metrics, "win_rate"),
        "win_rate_when_shorter_is_better": safe_float_metric(
            metrics, "win_rate_when_shorter_is_better"
        ),
        "win_rate_when_longer_is_better": safe_float_metric(
...
def write_relative_length_winrate_plot(
    output_dir: Optional[str],
    step: Optional[int],
    epoch: Optional[float],
    diagnostic_pairs: List[tuple],
